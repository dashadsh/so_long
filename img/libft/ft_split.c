...
/*   Updated: 2023/03/21 13:07:36 by dgoremyk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* count words by checking if it's the last letter of the word
(next = c or next = NULL) 
*/
...
3. nothing is happening to orig. string  - we need to move among that using
ft_split function
*/
